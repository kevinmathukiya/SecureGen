...
export const baseMetadata = {
  ...
  keywords: ['secure password generator', 'random password creator', 'strong password tool', 
    'client-side password generator', 'no-log password tool', 'cryptographic random string',
    'free password generator', 'uncrackable passwords','password generator', 'secure password', 'random password', 'strong password', 'password security', 'online password tool', 'free password generator', 'cryptographic password', 'generate password online', 'best password generator', 'password generator no tracking', 'client-side password generator'],
